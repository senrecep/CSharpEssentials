...
public readonly struct Any<T0, T1, T2, T3, T4>
{
    ...
    public static implicit operator Any<T0, T1, T2, T3, T4>(T0 value) => new(0, value);
    public static implicit operator Any<T0, T1, T2, T3, T4>(T1 value) => new(1, value);
    public static implicit operator Any<T0, T1, T2, T3, T4>(T2 value) => new(2, value);
    public static implicit operator Any<T0, T1, T2, T3, T4>(T3 value) => new(3, value);
    public static implicit operator Any<T0, T1, T2, T3, T4>(T4 value) => new(4, value);
