...
public readonly struct Any<T0, T1, T2, T3>
{
    ...
    public static implicit operator Any<T0, T1, T2, T3>(T0 value) => new(value);
    public static implicit operator Any<T0, T1, T2, T3>(T1 value) => new(value);
    public static implicit operator Any<T0, T1, T2, T3>(T2 value) => new(value);
    public static implicit operator Any<T0, T1, T2, T3>(T3 value) => new(value);
