...
public readonly struct Any<T0, T1, T2, T3, T4, T5, T6>
{
    ...
    public static implicit operator Any<T0, T1, T2, T3, T4, T5, T6>(T0 value) => new(value);
    public static implicit operator Any<T0, T1, T2, T3, T4, T5, T6>(T1 value) => new(value);
    public static implicit operator Any<T0, T1, T2, T3, T4, T5, T6>(T2 value) => new(value);
    public static implicit operator Any<T0, T1, T2, T3, T4, T5, T6>(T3 value) => new(value);
    public static implicit operator Any<T0, T1, T2, T3, T4, T5, T6>(T4 value) => new(value);
    public static implicit operator Any<T0, T1, T2, T3, T4, T5, T6>(T5 value) => new(value);
    public static implicit operator Any<T0, T1, T2, T3, T4, T5, T6>(T6 value) => new(value);
