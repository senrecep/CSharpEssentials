...
public class AnyT8Tests
{
    ...
    public void Switch_WhenEighth_ShouldExecuteEighthAction()
    {
        Any<int, string, bool, double, long, decimal, Guid, char> any = 'x';
        bool executed = false;
        AnyActionStatus status = any.Switch(eighth: _ => executed = true);
        executed.Should().BeTrue();
        status.Should().Be(AnyActionStatus.Executed);
    }
    ...
    {
        Any<int, string, bool, double, long, decimal, Guid, char> any = 42;
        AnyActionResult<int> result = any.Match(first: x => x * 2, second: _ => 0, third: _ => 0, fourth: _ => 0, fifth: _ => 0, sixth: _ => 0, seventh: _ => 0, eighth: _ => 0);
    ...
    {
        Any<int, string, bool, double, long, decimal, Guid, char> any = "hello";
        AnyActionResult<int> result = any.Match(first: _ => 0, second: x => x.Length, third: _ => 0, fourth: _ => 0, fifth: _ => 0, sixth: _ => 0, seventh: _ => 0, eighth: _ => 0);
        result.Status.Should().Be(AnyActionStatus.Executed);
    ...
    {
        Any<int, string, bool, double, long, decimal, Guid, char> any = true;
        AnyActionResult<int> result = any.Match(first: _ => 0, second: _ => 0, third: x => x ? 1 : 0, fourth: _ => 0, fifth: _ => 0, sixth: _ => 0, seventh: _ => 0, eighth: _ => 0);
        result.Status.Should().Be(AnyActionStatus.Executed);
    ...
    {
        Any<int, string, bool, double, long, decimal, Guid, char> any = 3.14;
        AnyActionResult<int> result = any.Match(first: _ => 0, second: _ => 0, third: _ => 0, fourth: x => (int)x, fifth: _ => 0, sixth: _ => 0, seventh: _ => 0, eighth: _ => 0);
        result.Status.Should().Be(AnyActionStatus.Executed);
    ...
    {
        Any<int, string, bool, double, long, decimal, Guid, char> any = 99L;
        AnyActionResult<int> result = any.Match(first: _ => 0, second: _ => 0, third: _ => 0, fourth: _ => 0, fifth: x => (int)x, sixth: _ => 0, seventh: _ => 0, eighth: _ => 0);
        result.Status.Should().Be(AnyActionStatus.Executed);
    ...
    {
        Any<int, string, bool, double, long, decimal, Guid, char> any = 3.99m;
        AnyActionResult<int> result = any.Match(first: _ => 0, second: _ => 0, third: _ => 0, fourth: _ => 0, fifth: _ => 0, sixth: x => (int)x, seventh: _ => 0, eighth: _ => 0);
        result.Status.Should().Be(AnyActionStatus.Executed);
        result.Result.Should().Be(3);
    }
    ...
    {
        Any<int, string, bool, double, long, decimal, Guid, char> any = TestGuid;
        AnyActionResult<int> result = any.Match(first: _ => 0, second: _ => 0, third: _ => 0, fourth: _ => 0, fifth: _ => 0, sixth: _ => 0, seventh: x => x.GetHashCode(), eighth: _ => 0);
        result.Status.Should().Be(AnyActionStatus.Executed);
    ...
    {
        Any<int, string, bool, double, long, decimal, Guid, char> any = 'x';
        AnyActionResult<int> result = any.Match(first: _ => 0, second: _ => 0, third: _ => 0, fourth: _ => 0, fifth: _ => 0, sixth: _ => 0, seventh: _ => 0, eighth: x => (int)x);
        result.Status.Should().Be(AnyActionStatus.Executed);
    ...
    public void JsonSerialization_First_ShouldRoundTrip()
    {
        ...
        Any<int, string, bool, double, long, decimal, Guid, char> deserialized = JsonSerializer.Deserialize<Any<int, string, bool, double, long, decimal, Guid, char>>(json);
