...
{
    public static IRuleBase<TContext> And<TContext>(this IEnumerable<IRuleBase<TContext>> rules) =>
        AndRuleAdapter<TContext>.From([.. rules]);

    public static IRuleBase<TContext, TResult> And<TContext, TResult>(this IEnumerable<IRuleBase<TContext, TResult>> rules) =>
