...
{
    public static IRuleBase<TContext> Or<TContext>(this IEnumerable<IRuleBase<TContext>> rules) =>
        OrRuleAdapter<TContext>.From([.. rules]);

    public static IRuleBase<TContext, TResult> Or<TContext, TResult>(this IEnumerable<IRuleBase<TContext, TResult>> rules) =>
