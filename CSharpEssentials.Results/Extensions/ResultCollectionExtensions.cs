...
{
    public static Result CombineAll(this IEnumerable<Result> source) => source.Cast<IResultBase>().CombineAll();
    ...
    public static Result<TValue[]> CombineAll<TValue>(this IEnumerable<Result<TValue>> source) => source.Cast<IResult<TValue>>().CombineAll();

    public static Result<TValue[]> CombineAll<TValue>(this IEnumerable<IResult<TValue>> source) => source.Sequence();

    public static Result<TValue[]> Sequence<TValue>(this IEnumerable<Result<TValue>> source) => source.Cast<IResult<TValue>>().Sequence();
    ...
    public static (TValue[] Successes, Error[] Errors) Partition<TValue>(this IEnumerable<Result<TValue>> source) =>
        source.Cast<IResult<TValue>>().Partition();
    ...
    public static Result FirstFailureOrSuccesses(this IEnumerable<Result> source) => source.Cast<IResultBase>().FirstFailureOrSuccesses();
    ...
    public static Result<TValue[]> FirstFailureOrSuccesses<TValue>(this IEnumerable<Result<TValue>> source) =>
        source.Cast<IResult<TValue>>().FirstFailureOrSuccesses();
