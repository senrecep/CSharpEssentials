...
public readonly struct Any<T0, T1, T2, T3, T4, T5>
{
    ...
    public static Any<T0, T1, T2, T3, T4, T5> First(T0 value) => value;
    public static Any<T0, T1, T2, T3, T4, T5> Second(T1 value) => value;
    public static Any<T0, T1, T2, T3, T4, T5> Third(T2 value) => value;
    public static Any<T0, T1, T2, T3, T4, T5> Fourth(T3 value) => value;
